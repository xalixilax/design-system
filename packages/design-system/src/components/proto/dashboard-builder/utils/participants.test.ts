...
describe("participants", () => {
  it("expands vertical participants across connected overlaps", () => {
    ...
    expect([...participants.rightIds]).toEqual(
      expect.arrayContaining(["right-top", "right-bottom"]),
    );
  });
  ...
  it("expands horizontal participants across connected overlaps", () => {
    ...
    expect([...participants.bottomIds]).toEqual(
      expect.arrayContaining(["bottom-left", "bottom-right"]),
    );
  });
});
